 ...
 */
final class ConverterCharacterOrCharSequenceHasTextOrStringToCharacterOrCharSequenceOrString<C extends ConverterContext> extends Converter2<C> {

    /**
     * Type safe instance getter
     */
    static <C extends ConverterContext> ConverterCharacterOrCharSequenceHasTextOrStringToCharacterOrCharSequenceOrString<C> instance() {
     ...
     * Singleton
     */
    private final static ConverterCharacterOrCharSequenceHasTextOrStringToCharacterOrCharSequenceOrString<?> INSTANCE = new ConverterCharacterOrCharSequenceHasTextOrStringToCharacterOrCharSequenceOrString<>();

    /**
     * Private to stop sub classing.
     */
    private ConverterCharacterOrCharSequenceHasTextOrStringToCharacterOrCharSequenceOrString() {
        super();
    }
