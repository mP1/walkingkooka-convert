...
public final class Converters implements PublicStaticHelper {
    ...
    /**
     * {@see ConverterCurrencyCodeToCurrency}
     */
    public static <C extends ConverterContext> Converter<C> currencyCodeToCurrency() {
        return ConverterCurrencyCodeToCurrency.instance();
    }

    /**
     * {@see ConverterCurrencyValueTo}
     */
    public static <C extends ConverterContext> Converter<C> currencyValueTo() {
        return ConverterCurrencyValueTo.instance();
    }
    ...
    /**
     * {@see ConverterTextToCollectionSetCurrencyCodeSet}
     */
    public static <C extends ConverterContext> Converter<C> textToCurrencyCodeSet() {
     ...
     */
    public static <C extends ConverterContext> Converter<C> textToLocalDate(final Function<DateTimeContext, DateTimeFormatter> formatter) {
    ...
    /**
     * {@see ConverterTextToCollectionSetLocaleLanguageTagSet}
     */
    public static <C extends ConverterContext> Converter<C> textToLocaleLanguageTagSet() {
    ...
    /**
     * {@see ConverterTextToCollectionSetTsvStringSet}
     */
    public static <C extends ConverterContext> Converter<C> textToTsvStringSet() {
        return ConverterTextToCollectionSetTsvStringSet.instance();
    }
