 ...
 */
final class ConverterLocaleToDecimalNumberSymbols<C extends ConverterContext> extends ConverterLocaleTo<DecimalNumberSymbols, C> {

    /**
     * Type safe getter.
     */
    static <C extends ConverterContext> ConverterLocaleToDecimalNumberSymbols<C> instance() {
        return INSTANCE;
    }
