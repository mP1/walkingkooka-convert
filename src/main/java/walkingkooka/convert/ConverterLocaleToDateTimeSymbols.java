 ...
 */
final class ConverterLocaleToDateTimeSymbols<C extends ConverterContext> extends ConverterLocaleTo<DateTimeSymbols, C> {

    /**
     * Type safe getter.
     */
    static <C extends ConverterContext> ConverterLocaleToDateTimeSymbols<C> instance() {
        return INSTANCE;
    }
