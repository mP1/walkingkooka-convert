...
public final class ConverterTextToLocaleLanguageTagTest extends ConverterTextToTestCase<ConverterTextToLocaleLanguageTag<ConverterContext>, LocaleLanguageTag> {
    ...
    @Override
    public ConverterTextToLocaleLanguageTag<ConverterContext> createConverter() {
    ...
    @Override
    public Class<ConverterTextToLocaleLanguageTag<ConverterContext>> type() {
        return Cast.to(ConverterTextToLocaleLanguageTag.class);
    }
}
