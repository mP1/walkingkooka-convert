...
public final class ConverterTextToCollectionListLocalDateTimeListTest extends ConverterTextToCollectionListTestCase<LocalDateTimeList, LocalDateTime, ConverterTextToCollectionListLocalDateTimeList<ConverterContext>> {
    ...
    @Override
    public ConverterTextToCollectionListLocalDateTimeList<ConverterContext> createConverter() {
    ...
    @Override
    Class<LocalDateTimeList> collectionType() {
    ...
    @Override
    public Class<ConverterTextToCollectionListLocalDateTimeList<ConverterContext>> type() {
        return Cast.to(ConverterTextToCollectionListLocalDateTimeList.class);
    }
}
