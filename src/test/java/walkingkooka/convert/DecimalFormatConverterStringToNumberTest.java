...
public final class DecimalFormatConverterStringToNumberTest extends DecimalFormatConverterTestCase<DecimalFormatConverterStringToNumber<ConverterContext>> {
    ...
    @Override
    DecimalFormatConverterStringToNumber<ConverterContext> createConverter(final Function<DecimalNumberContext, DecimalFormat> decimalFormat) {
        return DecimalFormatConverterStringToNumber.with(decimalFormat);
    }

    @Override
    public Class<DecimalFormatConverterStringToNumber<ConverterContext>> type() {
    ...
    public String typeNameSuffix() {
        return String.class.getSimpleName() + "To" + Number.class.getSimpleName();
    }
}
