...
public final class ConverterTextToCollectionSetTsvStringSetTest extends ConverterTextToCollectionSetTestCase<TsvStringSet, String, ConverterTextToCollectionSetTsvStringSet<ConverterContext>> {
    ...
    @Override
    public ConverterTextToCollectionSetTsvStringSet<ConverterContext> createConverter() {
    ...
    @Override
    Class<TsvStringSet> collectionType() {
        return TsvStringSet.class;
    }

    @Override
    TsvStringSet emptySet() {
    ...
    @Override
    public Class<ConverterTextToCollectionSetTsvStringSet<ConverterContext>> type() {
        return Cast.to(ConverterTextToCollectionSetTsvStringSet.class);
    }
}
