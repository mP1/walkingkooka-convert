...
[![Coverage Status](https://coveralls.io/repos/github/mP1/walkingkooka-convert/badge.svg)](https://coveralls.io/github/mP1/walkingkooka-convert)
...
- [binary-to-string](https://github.com/mP1/walkingkooka-convert/blob/master/src/main/java/walkingkooka/convert/ConverterBinaryToString.java)
...
- [text-to-currency-code-set](https://github.com/mP1/walkingkooka-convert/blob/master/src/main/java/walkingkooka/convert/ConverterTextToCollectionSetCurrencyCodeSet.java)
...
- [text-to-local-date-list](https://github.com/mP1/walkingkooka-convert/blob/master/src/main/java/walkingkooka/convert/ConverterTextToCollectionListDateList.java)
...
- [text-to-local-date-time-list](https://github.com/mP1/walkingkooka-convert/blob/master/src/main/java/walkingkooka/convert/ConverterTextToCollectionListDateTimeList.java)
- [text-to-local-time](https://github.com/mP1/walkingkooka-convert/blob/master/src/main/java/walkingkooka/convert/ConverterDateTimeFormatterStringToLocalTimeDateTimeFormatter.java)
- [text-to-local-time-list](https://github.com/mP1/walkingkooka-convert/blob/master/src/main/java/walkingkooka/convert/ConverterTextToCollectionListTimeList.java)
